    ...
    <script>
        ...
        function setupModalFunctionality() {
            ...
            $('#editScheduleModal').on('show.bs.modal', function(event) {
                ...
                currentScheduleData = {
                    day: row.find('td:eq(2)').text(),
                    shift: row.find('td:eq(3)').text(),
                    start_time: row.find('td:eq(4)').text(),
                    end_time: row.find('td:eq(5)').text()
                };
                                ...
                                <tbody id="schedules-table-body">
                                    <?php if(count($schedules) > 0): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $schedule['start_time'] ? date('h:i A', strtotime($schedule['start_time'])) : 'N/A'; ?></td>
                                            <td><?php echo $schedule['end_time'] ? date('h:i A', strtotime($schedule['end_time'])) : 'N/A'; ?></td>
                                            <td>
                                                <button class="btn btn-sm btn-warning action-btn" 
                                                        data-toggle="modal" 
