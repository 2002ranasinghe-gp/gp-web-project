            ...
            <div class="tab-pane fade show active" id="dashboard-tab">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-card card border-left-primary shadow h-100 py-2" style="background: linear-gradient(rgba(255,255,255,0.9), rgba(255,255,255,0.9)), url('images/appointment-bg.jpg') center/cover;">
